...
export type GalleryPhotoCreateInput = {
  ...
  photo: Prisma.PhotoCreateNestedOneWithoutGalleriesInput
}
...
export type GalleryPhotoUpdateInput = {
  ...
  photo?: Prisma.PhotoUpdateOneRequiredWithoutGalleriesNestedInput
}
...
export type GalleryPhotoOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"galleryId" | "photoId" | "createdAt", ExtArgs["result"]["galleryPhoto"]>
...
export interface GalleryPhotoDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const galleryPhotoWithGalleryIdOnly = await prisma.galleryPhoto.findMany({ select: { galleryId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many GalleryPhotos and only return the `galleryId`
   * const galleryPhotoWithGalleryIdOnly = await prisma.galleryPhoto.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more GalleryPhotos and only return the `galleryId`
   * const galleryPhotoWithGalleryIdOnly = await prisma.galleryPhoto.updateManyAndReturn({
   *   select: { galleryId: true },
   *   where: {
   *     // ... provide filter here
   *   },
